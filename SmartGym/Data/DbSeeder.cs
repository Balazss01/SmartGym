...
namespace GymWebApiBackend.Data
{
                ...
                var helyszinek = new List<Helyszin>
  {
      new Helyszin
      {
          ...
          Leiras = "Prémium konditerem a belváros szívében, modern gépekkel, személyi edzőkkel és wellness részleggel.",
          ...
          Szelesseg = 47.4979,
          Hosszusag = 19.0402,
          Kep = "/images/helyszinek/budapest-belvaros.jpg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "Személyi edző", "Csoportos órák", "Sauna", "Parkoló", "Büfé" }
      },
      new Helyszin
      {
          ...
          Szelesseg = 47.4924,
          Hosszusag = 19.0366,
          Kep = "/images/helyszinek/budapest.jpg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "Személyi edző", "Yoga", "Pilates", "Szekrények" }
      },
      new Helyszin
      {
          ...
          Szelesseg = 47.5316,
          Hosszusag = 21.6273,
          Kep = "/images/helyszinek/debrecen.jpg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "CrossFit", "Olimpiai emelés", "Személyi edző", "Parkoló", "Sauna" }
      },
      new Helyszin
      {
          ...
          Szelesseg = 48.1035,
          Hosszusag = 20.7784,
          Kep = "/images/helyszinek/miskolc.jpg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "Kardió", "Erőedzés", "Csoportos órák", "Szekrények" }
      },
      new Helyszin
      {
          Nev = "SmartGYM Pécs",
          ...
          Leiras = "Mediterrán hangulatú edzőterem tetőterasszal és úszómedencével.",
          ...
          Szelesseg = 46.0727,
          Hosszusag = 18.2330,
          Kep = "/images/helyszinek/pecs.jpeg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "Uszoda", "Tetőterasz", "Személyi edző", "Büfé", "Sauna" }
      },
      new Helyszin
      {
          Nev = "SmartGYM Győr",
          ...
          Szelesseg = 47.6875,
          Hosszusag = 17.6504,
          Kep = "/images/helyszinek/gyor.jpg",
          Aktiv = true,
      ...
      new Helyszin
      {
          ...
          Szelesseg = 47.1896,
          Hosszusag = 18.4116,
          Kep = "/images/helyszinek/szekesfehervar.jpg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "Powerlifting", "Funkcionális edzés", "Személyi edző" }
      },
      new Helyszin
      {
          Nev = "SmartGYM Sopron",
          ...
          Szelesseg = 47.6849,
          Hosszusag = 16.5855,
          Kep = "/images/helyszinek/sopron.jpg",
          Aktiv = true,
          Szolgaltatasok = new() { "24/7 nyitva", "Wellness", "Sauna", "Gőzfürdő", "Személyi edző", "Parkoló" }
      }
  };
